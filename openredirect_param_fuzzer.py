...
execucao_op_1 = "cat "+args.lista+"|httpx -path '/"+payload_op_1+"'-silent -fr -title|grep 'Example'"
execucao_op_2 = "cat "+args.lista+"|httpx -path '/"+payload_op_2+"'-silent -fr -title|grep 'Example'"
