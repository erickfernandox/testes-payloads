...
with open(args.lista, 'r') as f:
    ...
    for line in f:
        ...
        execucao_xss_1 = "echo '"+url+""+payload_xss_1+"'|httpx -mc 200 -mr '=alert(1)>'"
        execucao_xss_2 = "echo '"+url+""+payload_xss_2+"'|httpx -mc 200 -mr '=alert(1)>'"
        execucao_xss_3 = "echo '"+url+""+payload_xss_3+"'|httpx -mc 200 -mr '=alert(1)>'"
        execucao_xss_4 = "echo '"+url+""+payload_xss_4+"'|httpx -mc 200 -mr '=alert(1)>'"
