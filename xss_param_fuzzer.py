...
execucao_xss_1 = "cat "+urls+"|httpx -path '/"+payload_xss_1+"' -mc 200 |airixss -payload '\"XSS' | grep -Ev 'Not'"
execucao_xss_2 = "cat "+urls+"|httpx -path '/"+payload_xss_2+"' -mc 200 |airixss -payload '\"XSS' | grep -Ev 'Not'"
